...
extension ApiRequestHandler {
    ...
    func addOrder <R:Decodable> (_ order : Order, returnType : R.Type? = nil, completion:  ((Result<ReturnedResult<R>, Error>)->Void)? = nil){
        
        send(module: "order", dataObject: order, returnType: returnType,completion:  completion)
    }
