...
struct AboutView : View {
    ...
    @Binding var toPresentWeb : Bool
    
    @Binding var toPresentWebUrl : String
            ...
            VStack (alignment: .leading, spacing:30){
                ...
                Button(action: {
                    ...
                    withAnimation{
                        ...
                        toPresentWebUrl = "https://youtu.be/nXFGD52hP44"
                        isPresented = false
                        toPresentWeb = true
                    ...
                    Text("Intro Video Of KyPay App").font(.custom(Theme.fontNameBold, size: 16))
                ...
                Button(action: {
                    ...
                    withAnimation{
                        ...
                        toPresentWebUrl = "https://blog.techchee.com"
                        isPresented = false
                        toPresentWeb = true
